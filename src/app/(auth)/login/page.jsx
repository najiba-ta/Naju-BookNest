            ...
            <div className='p-4 rounded-lg bg-white p-16'>
               ...
               <form onSubmit={handleSubmit(handleLoginFunc)}>
                ...
                <p className='text-lg text-gray-500 font-thin text-center mt-8'>OR</p>
                 <button className='btn btn-soft text-center w-full my-5'>SignIn With Google</button>

                 <p className='text-gray-500 text-center mt-6'>Dindn't have an account?? <Link href={'/register'} className='text-red-600'>SignUp</Link></p>
               </form>
            </div>
